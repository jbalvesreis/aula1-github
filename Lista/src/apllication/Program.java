...
public class Program {
	...
	public static void main(String[] args) {
		...
		// deu erro
		// Remover todos que começão com "M"
		...
		// Manter na lista somente os que começam com "M"
		...
		System.out.println("--------------------");
		// Encontrar elemento que atenda 1 predicado. Primeiro elemento que começa com "A"
		// deu erro
